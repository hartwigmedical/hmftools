...
They are created from the [purplePlots.R](src/main/resources/r/purplePlots.R) script and can be regenerated by supplying the tumor name, 
PURPLE output directory and desired location to create the figures, eg.
```
Rscript purplePlots.R COLO829T ~/hmf/COLO829T/purple ~/hmf/COLO829T/purple/plot
``` 
