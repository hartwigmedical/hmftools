...
public interface StructuralVariantConfig {
    ...
    @NotNull
    static StructuralVariantConfig createStructuralVariantConfig(@NotNull CommandLine cmd, @NotNull Options opt) throws ParseException {
        ...
        if (cmd.hasOption(STRUCTURAL_VARIANT_RECOVERY)) {
