...
import static com.hartwig.hmftools.vicc.database.Tables.FEATURES;
...
public class ViccDAO {
    ...
    private void writeFeatures(int viccEntryId, @NotNull List<Feature> features) {
        for (Feature feature: features) {
            context.insertInto(FEATURES, FEATURES.NAME, FEATURES.VICCENTRYID).values(feature.name(), viccEntryId).execute();
