...
public class CRAMFileWriter extends SAMFileWriterImpl {
    ...
    public CRAMFileWriter(
            ...
            final String fileName, boolean writeHeader)
    {
        this(outputStream, null, referenceSource, samFileHeader, fileName, writeHeader); // defaults to presorted == true
    }
    ...
    public CRAMFileWriter(
            ...
            final String fileName, boolean writeHeader)
    {
        this(outputStream, indexOS, true, referenceSource, samFileHeader, fileName, writeHeader); // defaults to presorted==true
    }
    ...
    public CRAMFileWriter(final OutputStream outputStream, final OutputStream indexOS, final boolean presorted,
                          final CRAMReferenceSource referenceSource, final SAMFileHeader samFileHeader, final String fileName, boolean writeHeader) {
        this( new CRAMEncodingStrategy(), outputStream, indexOS, presorted, referenceSource, samFileHeader, fileName, writeHeader);
    }
    ...
    public CRAMFileWriter(
        ...
        cramContainerStream = new CRAMContainerStreamWriter(
                ...
                fileName);
        setHeader(samFileHeader, writeHeader);
    }
