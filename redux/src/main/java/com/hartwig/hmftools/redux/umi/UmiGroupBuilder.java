...
public class UmiGroupBuilder
{
    ...
    //            if(formCoordGroups)
    //            {
    //                // TODO: Get or create duplicate/single based on coordinates on forward and reverse
    //                CoordinateGroup coordGroup = getOrCreateCoordGroup(coordinateGroups, duplicateGroup.fragmentCoordinates_().Key);
    //
    //                // TODO: so we organise umis by coordinates
    ...
    //            {
    //                // TODO: capture umi similarity by this
    ...
    //            {
    //                // TODO: Now single reads get added back.
    ...
    //    }
    //
    //    public static List<DuplicateGroup> buildUmiGroups(final FragmentCoords fragCoords_, final List<SAMRecord> reads, final UmiConfig config)
    //    {
    ...
    //            if(group == null)
    //            {
    //                // TODO: Adding this based on umi
    //                groups.put(umiId, new DuplicateGroup(umiId, read, fragCoords_));
    //            }
    //            else
    //            {
    //                group.addRead(read);
    ...
    //    }
    //
    //    private CoordinateGroup getOrCreateCoordGroup(final List<CoordinateGroup> coordinateGroups, final String coordKey_)
    //    {
    //        for(CoordinateGroup coordinateGroup : coordinateGroups)
    //        {
    //            if(coordinateGroup.CoordKey.equals(coordKey_))
    //                return coordinateGroup;
    //        }
    //
    //        CoordinateGroup newGroup = new CoordinateGroup(coordKey_);
    ...
    //    {
    //        // TODO: Collapse forward and reverse for duplex
