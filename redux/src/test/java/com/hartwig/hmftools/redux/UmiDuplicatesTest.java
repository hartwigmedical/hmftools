...
public class UmiDuplicatesTest
{
    ...
    public void testPolyGCollapsingCreatedOrphanConsensusRead()
    {
        ...
        final BiFunction<String, Boolean, Stream<SAMRecord>> readStream = (final String readName, final Boolean isFirstOfPair) -> writtenRecords.stream().filter(x -> (x.getReadName().equals(readName) && x.getFirstOfPairFlag() == isFirstOfPair));
