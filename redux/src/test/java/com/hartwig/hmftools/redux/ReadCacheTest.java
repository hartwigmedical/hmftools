...
public class ReadCacheTest
{
    ...
    public void testUltimaDuplicateGroupCollapsing()
    {
        ...
        readCache.processRead(createUnpairedRecord(CHR_1, 100, 100, false));
        readCache.processRead(createUnpairedRecord(CHR_1, 100, 100 + SINGLE_END_JITTER_COLLAPSE_DISTANCE, false));
        readCache.processRead(createUnpairedRecord(CHR_1, 100, 100 + SINGLE_END_JITTER_COLLAPSE_DISTANCE, false));
        ...
        readCache.processRead(createUnpairedRecord(CHR_1, 100, 100 + SINGLE_END_JITTER_COLLAPSE_DISTANCE, false));
        readCache.processRead(createUnpairedRecord(CHR_1, 100, 100 + SINGLE_END_JITTER_COLLAPSE_DISTANCE, false));
        readCache.processRead(createUnpairedRecord(CHR_1, 100, 100 + 2 * SINGLE_END_JITTER_COLLAPSE_DISTANCE, false));
        readCache.processRead(createUnpairedRecord(CHR_1, 100, 100 + 2 * SINGLE_END_JITTER_COLLAPSE_DISTANCE, false));
