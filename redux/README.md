...
The transcript-aware RNA splice tooling now lives in its own module, **TARS** (Transcript Alignment for RNA Splicing).
See [tars/README.md](../tars/README.md). REDUX is splice-agnostic and simply consumes the genomic BAM that TARS produces.
