...
class LinkRescueTest {
    ...
    private val dedup: Set<String> = setOf("dedup")
    ...
    fun testPassAcrossLinks() {
        ...
        val variantStore = VariantStore(listOf(var1, var2, var3, var4, var5, var6, var7, var8))
        ...
        val victim = LinkRescue(0, linkStore, softFilterStore, variantStore)
