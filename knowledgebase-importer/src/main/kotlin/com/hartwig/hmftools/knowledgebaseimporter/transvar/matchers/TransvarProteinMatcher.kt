...
object TransvarProteinMatcher : Matcher {
    ...
    private val DELETION_RANGE = "${AA_RANGE}del"
    ...
    private val FRAMESHIFT = "${AA_POSITION}fs"
    private val FRAMESHIFT_WITH_ALT = "$AA_POSITION${AA}fs(\\*|Ter)(\\d+|\\?)"
    ...
    private fun matchesDeletion(input: String) = input.matchesPattern(DELETION) || input.matchesPattern(DELETION_RANGE)
