...
// Reader interface for knowledgebase events that contain multiple variants, any of which would lead to actionability
...
interface KnowledgebaseAnyEventReader<R, out T> : SomaticEventReader<R, T> where R : KnowledgebaseEvent, T : SomaticEvent {
    // Function that should split the single event into multiple events
