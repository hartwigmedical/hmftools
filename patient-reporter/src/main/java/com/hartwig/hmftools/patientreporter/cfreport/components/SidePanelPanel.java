...
public final class SidePanelPanel {
    ...
    private SidePanelPanel() {
    }

    public static void renderSidePanel(@NotNull PdfPage page, @NotNull PanelReport patientReport, boolean fullHeight, boolean fullContent) {
