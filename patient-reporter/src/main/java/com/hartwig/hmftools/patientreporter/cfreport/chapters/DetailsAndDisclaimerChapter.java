...
public class DetailsAndDisclaimerChapter implements ReportChapter {
    ...
    private static Div createDisclaimerDiv(@NotNull AnalysedPatientReport patientReport) {
        ...
        div.add(createContentParagraphTwiceWithOneBoldFiveParts("This report is generated by patient reporter ",
                ReportResources.VERSION_REPORT,
                " based on ",
                patientReport.qsFormNumber(), "."));
        div.add(createContentParagraph("UDI-DI: ", "01)8720299486003(8012)v5.22"));
        div.add(createContentParagraphThreeParts("The OncoAct user manual can be found at ", "https://www.oncoact.nl/manual", "."));
        div.add(createContentParagraphThreeParts("This report is based on pipeline version ", pipelineVersion, "."));
        ...
        div.add(createContentParagraphThreeParts("For feedback or complaints please contact ", ReportResources.CONTACT_EMAIL_QA, "."));
        div.add(createContentParagraphThreeParts("For questions about the contents of this report, please contact ",
    ...
    @NotNull
    private static Paragraph createContentParagraphTwiceWithOneBoldFiveParts(@NotNull String regularPart, @NotNull String boldPart,
