...
public final class ClinicalTrials {
    ...
    @NotNull
    public static List<ClinicalTrial> removeTrialsOnFilteredGermlineVariants(@NotNull List<ClinicalTrial> trials,
        ...
        for (ClinicalTrial trial : trials) {
            if (germlineReportingLevel != LimsGermlineReportingLevel.NO_REPORTING || !germlineEvents.contains(trial.event())) {
                filtered.add(trial);
            }
        }
