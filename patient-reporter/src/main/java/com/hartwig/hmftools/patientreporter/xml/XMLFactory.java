...
public class XMLFactory {
    ...
    public static ReportXML generateXMLData(@NotNull AnalysedPatientReport report) {
        ...
        xml.add(ImmutableKeyXML.builder()
                ...
                .valuePath(Map.of("value", DataUtil.formatPercentageRoundWithoutPercent(report.genomicAnalysis().impliedPurity())))
                .build());
        xml.add(ImmutableKeyXML.builder()
        ...
        if (report.molecularTissueOriginReporting() == null) {
            ...
            String cuppaLikelihood = DataUtil.formatPercentageDigit(report.molecularTissueOriginReporting().interpretLikelihood());
