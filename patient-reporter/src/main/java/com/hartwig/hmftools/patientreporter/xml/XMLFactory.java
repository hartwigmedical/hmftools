...
public class XMLFactory {
    ...
    public static ReportXML generateXMLData(@NotNull AnalysedPatientReport report) {
        ImmutableImportWGSXML importWGS = ImmutableImportWGSXML.builder()
                .refNummerWgs(ImmutableKeyXML.builder()
                        .keyPath("refNummerWgs")
                        .valuePath(Map.of("value", report.sampleReport().tumorSampleId()))
                        .build())
                .wgsRedenAanvraag(ImmutableKeyXML.builder().keyPath("wgsRedenAanvraag").valuePath(Map.of("value", Strings.EMPTY)).build())
                .wgsGevrOndzTher(ImmutableKeyXML.builder().keyPath("wgsGevrOndzTher").valuePath(Map.of("value", Strings.EMPTY)).build())
                ...
                .wgsPercNeoCellenBeoord(ImmutableKeyXML.builder()
                        ...
                        .valuePath(Map.of("value", Strings.EMPTY))
                        .build())
                .wgsPercNeoCellen(ImmutableKeyXML.builder().keyPath("wgsPercNeoCellen").valuePath(Map.of("value", Strings.EMPTY)).build())
                ...
                .wgsPlatformAnd(ImmutableKeyXML.builder().keyPath("wgsPlatformAnd").valuePath(Map.of("value", Strings.EMPTY)).build())
                ...
                .gainsAndLosses(addGainLossesToXML(report.genomicAnalysis().gainsAndLosses(), report.genomicAnalysis().cnPerChromosome()))
