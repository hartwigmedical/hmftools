...
public class TumorCharacteristicsChapter extends ReportChapter {
    ...
    protected void renderChapterContent(@NotNull Document report) {
        ...
        report.add(createCharacteristicDiv("HR-Deficiency score", String.format("%.0f", hrDeficiency),
        ...
        report.add(createCharacteristicDiv("Microsatellite status", String.format("%s %.4f", microSatelliteStabilityString, microSatelliteStability),
        ...
        report.add(createCharacteristicDiv("Tumor mutational load", String.format("%s %.0f", mutationalLoadString, mutationalLoad),
        ...
        report.add(createCharacteristicDiv("Tumor mutational burden", String.format("%.1f variants per Mb", mutationalBurden),
