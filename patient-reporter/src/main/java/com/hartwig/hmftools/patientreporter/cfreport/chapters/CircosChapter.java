        ...
        table.addCell(TableUtil.getLayoutCell()
                .add(new Div().add(createContentParagraph("The outer first circle",
                        ...
                        .add(createContentParagraph("The second circle",
                                "shows the somatic variants (incl. exon, intron and intergenic regions). Somatic variants "
                                        + "are further divided into an outer ring of single nucleotide polymorphism (SNP) allele "
                                        + "frequencies and an inner ring of short insertion/deletion (INDEL) locations. SNP allele "
                                        + "frequencies have been corrected for tumor purity and scale from 0 to 100%. Each dot represents "
                                        + "a single somatic variant. SNPs are colored according to the type of base change "
