...
public abstract class SVReportPage {
    ...
    @NotNull
    private static final String TITLE = "Structural Variant Report";
        ...
        if (report.geneDisruptions().size() > 0) {
            table = cmp.subreport(
                        baseTable().setColumnStyle(dataStyle().setFontSize(fontSize))
                            ...
                            .columns(
                                col.column("Gene", GeneDisruptionDataSource.GENE_FIELD).setFixedWidth(50),
        ...
        if (report.geneFusions().size() > 0) {
            table = cmp.subreport(
                         baseTable().setColumnStyle(dataStyle().setFontSize(fontSize))
                            ...
                            .columns(
                                col.column("5' Gene", GeneFusionDataSource.GENE_FIELD).setFixedWidth(50),
