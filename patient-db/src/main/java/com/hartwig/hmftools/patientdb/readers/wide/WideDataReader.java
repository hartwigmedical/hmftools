...
public class WideDataReader {
    private static final Logger LOGGER = LogManager.getLogger(WideDataReader.class);
    ...
    public static Map<String, WideTreatmentData> buildTreatmentData(@NotNull final String pathToCsv) throws IOException {
        ...
        for (final String line : lines.subList(1, lines.size())) {
            ...
            if (parts.length == TREATMENT_DATA_COUNT) {
                WideTreatmentData wideTreatmentData = ImmutableWideTreatmentData.of(parts[TREATMENT_DATA_ID],
    ...
    public static Map<String, WidePreTreatmentData> buildPreTreatmentData(@NotNull final String pathToCsv) throws IOException {
        ...
        for (final String line : lines.subList(1, lines.size())) {
            ...
            if (parts.length == PRE_TREATMENT_DATA_COUNT) {
                WidePreTreatmentData widePreTreatmentData = ImmutableWidePreTreatmentData.of(parts[PRE_TREATMENT_DATA_PATIENT_ID],
