...
public final class DumpPrimaryTumorData {
    ...
    public static void writePatientTumorCurationStatesToTSV(@NotNull String outputTsv,
    ...
    public static void writeCuratedPrimaryTumorsToTSV(@NotNull String outputTsv, @NotNull Collection<Patient> patients) throws IOException {
