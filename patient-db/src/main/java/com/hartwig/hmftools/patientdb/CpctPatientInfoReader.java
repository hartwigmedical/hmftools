...
class CpctPatientInfoReader {
    ...
    CpctPatientInfoReader(@NotNull CpctEcrfModel model) {
        this.hospitals = getHospitals(model);
    }

    @NotNull
    PatientInfo read(@NotNull EcrfPatient patient) {
    ...
    @Nullable
    private static Integer getBirthYear(@NotNull EcrfPatient patient) {
