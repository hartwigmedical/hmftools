...
public class LoadEvidenceData {
    ...
    public static void main(@NotNull final String[] args) throws ParseException, IOException, SQLException {
        ...
        List<ReportableVariant> extractAllReportableVariants =
                extarctReportableVariants(passSomaticVariants, geneCopyNumbers, driverGeneView);
    ...
    @NotNull
    private static List<ReportableVariant> extarctReportableVariants(@NotNull List<SomaticVariant> passSomaticVariants,
