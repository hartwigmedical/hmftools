CREATE TABLE patientInfo
 ( id int NOT NULL AUTO_INCREMENT, cpctId varchar(255) DEFAULT NULL, drupId varchar(255) DEFAULT NULL, sex varchar(10) DEFAULT NULL, birthYear int DEFAULT NULL, hospital varchar(255) DEFAULT NULL, ethnicity varchar(255) DEFAULT NULL, PRIMARY KEY (id) );
