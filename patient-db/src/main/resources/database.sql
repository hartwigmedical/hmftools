...
(   patientId int NOT NULL,
    ...
    primaryTumorOverridden TINYINT,
    deathDate DATE,
...
(   modified DATETIME NOT NULL,
    gene varchar(50) NOT NULL,
    reportMissense TINYINT NOT NULL,
    reportNonsense TINYINT NOT NULL,
    reportSplice TINYINT NOT NULL,
    reportDeletion TINYINT NOT NULL,
    reportDisruption TINYINT NOT NULL,
    reportAmplification TINYINT NOT NULL,
    reportSomaticHotspot TINYINT NOT NULL,
...
(   sampleId varchar(255) NOT NULL,
    ...
    sufficientCoverage TINYINT NOT NULL,
    PRIMARY KEY (sampleId)
);
...
(   id int NOT NULL AUTO_INCREMENT,
    ...
    wholeGenomeDuplication TINYINT NOT NULL,
...
(   id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    chromosomeBand varchar(255) NOT NULL,
    transcriptId varchar(255) NOT NULL,
    canonicalTranscript TINYINT NOT NULL,
...
(   id int NOT NULL AUTO_INCREMENT,
    ...
    canonicalTranscript TINYINT NOT NULL DEFAULT 1,
...
(   id int NOT NULL AUTO_INCREMENT,
    ...
    fragileSiteStart TINYINT NOT NULL,
    fragileSiteEnd TINYINT NOT NULL,
    isFoldback TINYINT NOT NULL,
...
(   id int NOT NULL AUTO_INCREMENT,
    ...
    lowerBreakendIsStart TINYINT NOT NULL,
    upperBreakendIsStart TINYINT NOT NULL,
    chromosome VARCHAR(10),
    arm VARCHAR(3),
    assembled TINYINT NOT NULL,
...
(   id INT UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    sampleId varchar(50) NOT NULL,
    svId INT NOT NULL,
    startBreakend TINYINT NOT NULL,
    ...
    disruptive TINYINT NOT NULL,
    reportedDisruption TINYINT NOT NULL,
