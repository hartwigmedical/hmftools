...
public final class TestCuratorFactory {
    ...
    public static final String BIOPSY_SITE_MAPPING_TSV = Resources.getResource("curators/test_biopsy_site_mapping.tsv").getPath();
    public static final String TREATMENT_MAPPING_TSV = Resources.getResource("curators/test_treatment_mapping.tsv").getPath();
