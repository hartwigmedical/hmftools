...
public final class TestCuratorFactory {
    ...
    public static final String DOID_FILE = Resources.getResource("curators/doid.owl").getPath();
    ...
    @NotNull
    public static TumorLocationCuratorV2 tumorLocationV2Curator() throws OWLOntologyCreationException {
        try {
            return new TumorLocationCuratorV2(TUMOR_LOCATION_V2_MAPPING_TSV, DOID_FILE);
        } catch (IOException e) {
