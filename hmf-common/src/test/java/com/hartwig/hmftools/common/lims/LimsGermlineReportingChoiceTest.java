...
public class LimsGermlineReportingChoiceTest {
    ...
    public void canExtractGermlineChoice() {
        ...
        assertEquals(LimsGermlineReportingChoice.UNKNOWN, LimsGermlineReportingChoice.fromLimsGermlineReportingChoiceString("", "COLO02991111T"));
        assertEquals(LimsGermlineReportingChoice.UNKNOWN, LimsGermlineReportingChoice.fromLimsGermlineReportingChoiceString("", "CORE02991111T"));
    }
