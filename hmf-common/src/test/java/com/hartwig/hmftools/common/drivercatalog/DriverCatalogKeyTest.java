...
public class DriverCatalogKeyTest {
    ...
    public void canCreateUniqueKeySetMap() {
        ...
        DriverCatalog driverGene2 = DriverCatalogTestFactory.createCanonicalSomaticMutationEntryForGene(gene1, likelihood, "transcript2");
        DriverCatalog driverGene3 = DriverCatalogTestFactory.createCanonicalSomaticMutationEntryForGene(gene2, likelihood, "transcript3");
