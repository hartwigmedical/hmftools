...
public class StrelkaAllelicDepthTest {
    ...
    @Test
    public void testSNP() {
        final String line = "1\t13\t.\tG\tA\t.\tPASS\tAC=0;AF=0.0;AN=0;NT=ref;QSS=13;QSS_NT=13;SGT=GG->AG;SOMATIC;TQSS=1;TQSS_NT=1;set=snvs\tGT:AU:CU:DP:FDP:GU:SDP:SUBDP:TU\t0/0:0,0:0,1:19:2:17,20:0:0:0,0\t0/1:7,8:0,1:53:7:39,53:0:0:0,0";
    ...
    public void testNonSNPNonIndel() {
        final String line = "1\t10352\t.\tT\t.\t.\tQSS_ref\tNT=ref;QSS=1;QSS_NT=1;SGT=TT->TT;SOMATIC;TQSS=1;TQSS_NT=1\tDP:FDP:SDP:SUBDP:AU:CU:GU:TU\t62:17:37:0:0,4:0,5:0,0:45,107\t173:53:93:0:6,26:0,8:0,2:114,341";
    ...
    public void testSNPWithNonEssentialAttributeMissing() {
        final String lineWithNonEssentialAttributesMissing = "1\t13\t.\tG\tA\t.\tPASS\tAC=0;AF=0.0;AN=0;NT=ref;QSS=13;QSS_NT=13;SGT=GG->AG;SOMATIC;TQSS=1;TQSS_NT=1;set=snvs\tGT:AU:DP:FDP:GU:SDP:SUBDP:TU\t0/0:0,0:19:2:17,20:0:0:0,0\t0/1:7,8:53:7:39,53:0:0:0,0";
    ...
    public void testSNPWithEssentialAttributeMissing() {
        final String lineWithEssentialAttributesMissing = "1\t13\t.\tG\tA\t.\tPASS\tAC=0;AF=0.0;AN=0;NT=ref;QSS=13;QSS_NT=13;SGT=GG->AG;SOMATIC;TQSS=1;TQSS_NT=1;set=snvs\tGT:CU:DP:FDP:GU:SDP:SUBDP:TU\t0/0:0,1:19:2:17,20:0:0:0,0\t0/1:0,1:53:7:39,53:0:0:0,0";
    ...
    public void testIndel() {
        final String line = "1\t50\t.\tC\tCAG\t.\tPASS\tAC=0;AF=0.0;AN=0;IC=1;IHP=5;NT=ref;QSI=15;QSI_NT=15;RC=0;RU=AG;SGT=ref->het;SOMATIC;TQSI=1;TQSI_NT=1;set=indels\tGT:DP:DP2:DP50:FDP50:SUBDP50:TAR:TIR:TOR\t0/0:30:30:28.39:2.89:0.0:29,40:0,0:1,2\t0/1:66:66:65.8:3.11:0.0:57,103:9,11:0,4\n";
        final VariantContext victim = StrelkaAllelicDepth.enrich(codec.decode(line));
        assertTrue(victim.getGenotype(TUMOR).hasAD());
    ...
    public void testKeepExistingAD() {
        final String line = "1\t13\t.\tG\tA\t.\tPASS\tAC=0;AF=0.0;AN=0;NT=ref;QSS=13;QSS_NT=13;SGT=GG->AG;SOMATIC;TQSS=1;TQSS_NT=1;set=snvs\tGT:AU:CU:DP:FDP:GU:SDP:SUBDP:TU:AD\t0/0:0,0:0,1:19:2:17,20:0:0:0,0:1,2\t0/1:7,8:0,1:53:7:39,53:0:0:0,0:3,4";
