...
public class BamMaker
{
    public static void main(String[] args) throws Exception
    {
        ...
        BamRecipe bamRecipe = new BamRecipe(new ConstantChromosomeLengths(8_000));
        int regionOffset = 1;
        //        BamRecipe bamRecipe = new BamRecipe(new RefGenomeBackedChromosomeLengths(refGenomeSource));
        ChromosomeRegionDepths chr1Depths50 = new GCRatioChromosomeRegionDepths(_1, 0.5);
        chr1Depths50.addRange(regionOffset, regionOffset + 1000, 100);
        regionOffset += 1000;
        chr1Depths50.addRange(regionOffset, regionOffset + 1000, 100);
        bamRecipe.add(chr1Depths50);

        ChromosomeRegionDepths chr1Depths51 = new GCRatioChromosomeRegionDepths(_1, 0.51);
        regionOffset += 1000;
        chr1Depths51.addRange(regionOffset, regionOffset + 1000, 100);
        regionOffset += 1000;
        chr1Depths51.addRange(regionOffset, regionOffset + 1000, 100);
        bamRecipe.add(chr1Depths51);

        ChromosomeRegionDepths chr1Depths52 = new GCRatioChromosomeRegionDepths(_1, 0.52);
        regionOffset += 1000;
        chr1Depths52.addRange(regionOffset, regionOffset + 1000, 100);
        regionOffset += 1000;
        chr1Depths52.addRange(regionOffset, regionOffset + 1000, 0);
        bamRecipe.add(chr1Depths52);

        ChromosomeRegionDepths chr1Depths53 = new GCRatioChromosomeRegionDepths(_1, 0.53);
        regionOffset += 1000;
        chr1Depths53.addRange(regionOffset, regionOffset + 1000, 100);
        regionOffset += 1000;
        chr1Depths53.addRange(regionOffset, regionOffset + 1000, 100);
        bamRecipe.add(chr1Depths53);
        ...
        */
        ...
        File bamFile = new File(outputDir, "depth_0_windows.bam");
