...
public class DriverCatalogMapTest
{
    ...
    public void canMapDriverCatalog()
    {
        ...
        DriverCatalog driverGene1 = DriverCatalogTestFactory.createCanonicalSomaticMutationEntryForGene(
                gene1, likelihood, "transcript1", DriverCategory.ONCO);
        DriverCatalog driverGene2 = DriverCatalogTestFactory.createCanonicalSomaticMutationEntryForGene(
                gene1, likelihood, "transcript2", DriverCategory.ONCO);
        DriverCatalog driverGene3 = DriverCatalogTestFactory.createCanonicalSomaticMutationEntryForGene(
                gene2, likelihood, "transcript3", DriverCategory.ONCO);
