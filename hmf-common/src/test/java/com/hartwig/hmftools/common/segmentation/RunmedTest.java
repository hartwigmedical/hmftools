...
public class RunmedTest
{
    ...
    public void compareWithR() {
        ...
        check(new double[]{1.0, 3.0, 5.0, 2.0, 8.0, 7.0, 8.0, 3.0, 12.0}, new double[]{3.0, 3.0, 3.0, 5.0, 7.0, 8.0, 7.0, 8.0, 10.0}, 3);
        check(new double[]{1.0, 3.0, 5.0, 2.0, 8.0, 7.0, 8.0, 3.0, 12.0}, new double[]{3.0, 3.0, 3.0, 5.0, 7.0, 7.0, 8.0, 8.0, 8.0}, 5);

        check(new double[]{3.0, 1.0, 4.0, 1.0, 5.0, 9.0, 2.0, 6.0, 5.0, 3.0, 5.0, 9.0}, new double[]{3.0, 3.0, 1.0, 4.0, 5.0, 5.0, 6.0, 5.0, 5.0, 5.0, 5.0, 5.0}, 3);
        check(new double[]{3.0, 1.0, 4.0, 1.0, 5.0, 9.0, 2.0, 6.0, 5.0, 3.0, 5.0, 9.0}, new double[]{3.0, 3.0, 3.0, 4.0, 4.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0}, 5);
        check(new double[]{3.0, 1.0, 4.0, 1.0, 5.0, 9.0, 2.0, 6.0, 5.0, 3.0, 5.0, 9.0}, new double[]{3.0, 3.0, 3.0, 3.0, 4.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0}, 7);
