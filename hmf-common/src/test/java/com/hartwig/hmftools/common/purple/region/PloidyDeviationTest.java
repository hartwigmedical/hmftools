...
public class PloidyDeviationTest {
    ...
    //        final PloidyDeviation victim = new PloidyDeviation(0.03, 0, 1, 1);
    //        assertEquals(1.000, victim.majorAlleleDeviation(0.4, 0.63, 0.1), EPSILON);
    //        assertEquals(1.000, victim.majorAlleleDeviation(0.4, 0.63, 0.2), EPSILON);
    //        assertEquals(1.000, victim.majorAlleleDeviation(0.4, 0.63, 0.3), EPSILON);
    //        assertEquals(1.000, victim.majorAlleleDeviation(0.4, 0.63, 0.4), EPSILON);
    //        assertEquals(0.964, victim.majorAlleleDeviation(0.4, 0.63, 0.5), EPSILON);
    //        assertEquals(0.907, victim.majorAlleleDeviation(0.4, 0.63, 0.6), EPSILON);
    //        assertEquals(0.792, victim.majorAlleleDeviation(0.4, 0.63, 0.7), EPSILON);
    //        assertEquals(0.599, victim.majorAlleleDeviation(0.4, 0.63, 0.8), EPSILON);
    //        assertEquals(0.326, victim.majorAlleleDeviation(0.4, 0.63, 0.9), EPSILON);
