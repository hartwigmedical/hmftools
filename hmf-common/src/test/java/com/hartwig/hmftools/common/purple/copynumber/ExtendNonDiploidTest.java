...
public class ExtendNonDiploidTest {
    ...
    public void testIsEligible() {
        ...
        assertTrue(ExtendNonDiploid.isEligible(ImmutableFittedRegion.builder().from(eligible).status(GermlineStatus.AMPLIFICATION).build(), null));
        assertTrue(ExtendNonDiploid.isEligible(ImmutableFittedRegion.builder().from(eligible).status(GermlineStatus.HOM_DELETION).build(), null));
        assertTrue(ExtendNonDiploid.isEligible(ImmutableFittedRegion.builder().from(eligible).status(GermlineStatus.UNKNOWN).build(), null));

        assertTrue(ExtendNonDiploid.isEligible(ImmutableFittedRegion.builder().from(eligible).support(SegmentSupport.NONE).build(), eligible));
        ...
        assertFalse(ExtendNonDiploid.isEligible(ImmutableFittedRegion.builder().from(eligible).status(GermlineStatus.DIPLOID).build(), null));
