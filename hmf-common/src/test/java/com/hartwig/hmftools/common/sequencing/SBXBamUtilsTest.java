...
{
    private static String ZERO_QUAL = String.valueOf(phredToFastq(0));
    private static String NON_ZERO_QUAL = String.valueOf(phredToFastq(DUPLEX_QUAL));
    ...
    public void testStripDuplexIndelsForwardRead()
    {
        ...
        SAMRecord expectedRead = createSamRecordUnpaired("READ_001", CHR_1, alignmentStart, expectedReadStr, expectedCigar, false, false, null);
    ...
    public void testStripDuplexIndelsReverseRead()
    {
        ...
        SAMRecord expectedRead = createSamRecordUnpaired("READ_001", CHR_1, alignmentStart, expectedReadStr, expectedCigar, true, false, null);
        expectedRead.setBaseQualityString(expectedQualStr);
        expectedRead.setMappingQuality(expectedMapq);
        expectedRead.setAttribute("YC", ycTagStr);
        expectedRead.setAttribute(NUM_MUTATONS_ATTRIBUTE, expectedNm);
