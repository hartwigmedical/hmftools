...
public class DoubleArrayTest extends SegmentationTestBase
{
    ...
    public void powerSetTest()
    {
        ...
        assertTrue(powerSet1.contains(Collections.emptySet()));
        assertTrue(powerSet1.contains(new HashSet<>(List.of(1))));

        Set<Integer> set2 = new HashSet<>(Arrays.asList(1, 2));
        Set<Set<Integer>> powerSet2 = powerSet(set2);
        assertEquals(4, powerSet2.size());
        assertTrue(powerSet2.contains(Collections.emptySet()));
        assertTrue(powerSet2.contains(new HashSet<>(List.of(1))));
        assertTrue(powerSet2.contains(new HashSet<>(List.of(2))));
        ...
        assertTrue(powerSet3.contains(Collections.emptySet()));
        assertTrue(powerSet3.contains(new HashSet<>(List.of(1))));
        assertTrue(powerSet3.contains(new HashSet<>(List.of(2))));
        assertTrue(powerSet3.contains(new HashSet<>(List.of(3))));
    ...
    public void splitByIndexesTest()
    {
        ...
        List<double[]> result2 = splitByIndexes(d(1, 2), new HashSet<>(List.of(1)));
        assertEquals(2, result2.size());
        assertArrayEquals(d(1), result2.get(0), 1e-10);
        assertArrayEquals(d(2), result2.get(1), 1e-10);

        List<double[]> result3 = splitByIndexes(d(1, 2, 3), new HashSet<>(List.of(1)));
        assertEquals(2, result3.size());
        assertArrayEquals(d(1), result3.get(0), 1e-10);
        assertArrayEquals(d(2, 3), result3.get(1), 1e-10);

        List<double[]> result4 = splitByIndexes(d(1, 2, 1), new HashSet<>(List.of(1)));
        ...
        List<double[]> result6 = splitByIndexes(d(1, 2, 3, 5, 7), new HashSet<>(List.of(2)));
    ...
    public void splitAtTest()
    {
        ...
        assertArrayEquals(d(1), result1.getLeft(), 1e-10);
        assertArrayEquals(d(2), result1.getRight(), 1e-10);

        Pair<double[], double[]> result2 = splitAt(d(1, 2, 3), 1);
        assertArrayEquals(d(1), result2.getLeft(), 1e-10);
        assertArrayEquals(d(2, 3), result2.getRight(), 1e-10);

        Pair<double[], double[]> result3 = splitAt(d(1, 2, 3), 2);
        assertArrayEquals(d(1, 2), result3.getLeft(), 1e-10);
        assertArrayEquals(d(3), result3.getRight(), 1e-10);

        Pair<double[], double[]> result4 = splitAt(d(1, 2, 3, 4, 5), 3);
        assertArrayEquals(d(1, 2, 3), result4.getLeft(), 1e-10);
        assertArrayEquals(d(4, 5), result4.getRight(), 1e-10);
    }
