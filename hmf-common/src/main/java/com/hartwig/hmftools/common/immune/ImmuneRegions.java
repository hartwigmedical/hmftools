...
{
    private static final int TRANSCRIPT_FLANK = 5_000;
    ...
    public static final ChrBaseRegion HLA_A_REGION_V38 =
            new ChrBaseRegion("chr6", 29942532 - TRANSCRIPT_FLANK, 29945870 + TRANSCRIPT_FLANK);
    public static final ChrBaseRegion HLA_B_REGION_V38 =
            new ChrBaseRegion("chr6", 31353872 - TRANSCRIPT_FLANK, 31367067 + TRANSCRIPT_FLANK);
    public static final ChrBaseRegion HLA_C_REGION_V38 =
            new ChrBaseRegion("chr6", 31268749 - TRANSCRIPT_FLANK, 31272092 + TRANSCRIPT_FLANK);
