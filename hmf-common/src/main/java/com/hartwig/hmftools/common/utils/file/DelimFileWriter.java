...
public class DelimFileWriter<T> implements AutoCloseable
{
    ...
    public static class Row
    {
        ...
        public void setOrNull(String key, Character value) { set(key, value == null ? sNullIndicator : value.toString()); }
        ...
        public void setOrNull(Enum<?> key, Character value) { setOrNull(key.name(), value); }
        public void setOrNull(Enum<?> key, Boolean value) { setOrNull(key.name(), value); }
        public void setOrNull(Enum<?> key, Integer value) { setOrNull(key.name(), value); }
    }
