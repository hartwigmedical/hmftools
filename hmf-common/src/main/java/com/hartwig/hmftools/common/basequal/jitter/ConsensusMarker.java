...
public abstract class ConsensusMarker
{
    ...
    protected static Pair<Integer, Integer> getMicrosatelliteBoundaries(final RefGenomeMicrosatellite refGenomeMicrosatellite,
    ...
    protected int minQualInMicrosatellite(final RefGenomeMicrosatellite refGenomeMicrosatellite, final SAMRecord record)
    {
