...
import com.hartwig.hmftools.common.utils.io.exception.EmptyFolderException;
import com.hartwig.hmftools.common.utils.io.exception.FolderDoesNotExistException;
import com.hartwig.hmftools.common.utils.io.exception.NotFolderException;
...
public interface FolderChecker {
    ...
    @NotNull
    String checkFolder(@NotNull String directory) throws IOException;
    ...
    static void checkIfDirectoryIsNotEmpty(@NotNull final File directory) throws IOException {
