...
public class GenericDataCollection
{
    ...
    public void addDecimalValues(final List<Double> dataValues)
    {
        mDecimalData.add(dataValues);
    }

    public void addIntValues(final List<Integer> dataValues)
    {
        mIntData.add(dataValues);
    }

    public void addStringValues(final List<String> dataValues)
    {
        mStringData.add(dataValues);
    }
    ...
    public final List<List<Double>> getDecimalData()
    {
        return mDecimalData;
    }

    public final List<List<Integer>> getIntData()
    {
        return mIntData;
    }

    public final List<List<String>> getStringData()
    {
        return mStringData;
    }
