...
public class ProbeGenerationResultTest
{
    ...
    public void testAdd()
    {
        ProbeGenerationResult result1 = new ProbeGenerationResult(
                ...
                List.of(RejectedFeature.fromRegion(
                        new ChrBaseRegion("4", 40, 50), new TargetMetadata(TargetMetadata.Type.CUSTOM_REGION, "4")))
        );
        ProbeGenerationResult result2 = new ProbeGenerationResult(
                ...
                List.of(RejectedFeature.fromRegion(
                        new ChrBaseRegion("8", 80, 90), new TargetMetadata(TargetMetadata.Type.CN_BACKBONE, "8")))
        );
