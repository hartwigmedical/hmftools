...
public class ReadContextTest {
    ...
    public void testExpand() {
        ...
        final ReadContext allIncompleteLeft = initial.extend(initial.readBasesLeftCentreIndex() - 4, initial.readBasesRightCentreIndex()  + 2);
        assertTrue(allIncompleteLeft.incompleteCore());
        assertEquals("CATACGCAGT", allIncompleteLeft.centerBases());

        final ReadContext allIncompleteRight = initial.extend(initial.readBasesLeftCentreIndex() - 3, initial.readBasesRightCentreIndex()  + 3);
