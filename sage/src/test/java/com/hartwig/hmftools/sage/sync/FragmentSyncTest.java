...
public class FragmentSyncTest
{
    ...
    public void testMismatches()
    {
        ...
        first = createSamRecord(
                readId, chromosome, 10, REF_BASES.substring(10, 40), "30M");
        ...
        // INDEL vs aligned
        first = createSamRecord(
                readId, chromosome, 10, REF_BASES.substring(10, 20) + REF_BASES.substring(25, 40), "10M5D15M");
        ...
        // different INDELs
        first = createSamRecord(
                readId, chromosome, 10, REF_BASES.substring(10, 20) + "C" + REF_BASES.substring(20, 40), "10M1I20M");
    ...
    public void testTruncatedFragments()
    {
        ...
        SAMRecord first = createSamRecord(readId, CHR_1, 5, REF_BASES.substring(5, 35), "30M");
        ...
        int fragLength = 22;
        first = createSamRecord(readId, CHR_1, 11, REF_BASES.substring(9, 50), "2S35M4S");
        first.setInferredInsertSize(fragLength);

        second = createSamRecord(readId, CHR_1, 11, REF_BASES.substring(5, 45), "6S32M2S");
        ...
        fragLength = 43 - 8 + 1;
        first = createSamRecord(
                readId, CHR_1, 8, REF_BASES.substring(8, 23) + REF_BASES.substring(28, 45), "15M5D15M2S");
        first.setInferredInsertSize(fragLength);

        second = createSamRecord(
                readId, CHR_1, 11, REF_BASES.substring(5, 23) + REF_BASES.substring(28, 43), "6S12M5D15M");
    ...
    public void testTruncatedFragmentIndelMismatch()
    {
        ...
        SAMRecord first = createSamRecord(
                readId, CHR_1, 4, REF_BASES.substring(4, 8) + REF_BASES.substring(10, 40), "4M2D30M");
