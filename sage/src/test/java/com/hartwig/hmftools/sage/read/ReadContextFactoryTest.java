...
public class ReadContextFactoryTest {
    ...
    public void testSimpleInsert() {
        ...
        ReadContext victium = ReadContextFactory.createInsertContext("AGGC", 1000, 1, record, 0, refSequence.getBytes());
    ...
    public void testInsertInRepeat() {
        ...
        ReadContext victium = ReadContextFactory.createInsertContext("GA", 1000, 1, record, 0, refSequence.getBytes());
    ...
    public void testInsertAtHomology() {
        ...
        ReadContext victium = ReadContextFactory.createInsertContext("ATCA", 1000, 1, record, 0, refSequence.getBytes());
    ...
    public void testInsertAtHomologyWithAdditionalBases() {
        ...
        ReadContext victium = ReadContextFactory.createInsertContext("GATCA", 1000, 4, record, 0, refSequence.getBytes());
    ...
    public void testDeleteAtHomology() {
        ...
        ReadContext victium = ReadContextFactory.createDelContext("GATCGG", 1000, 0, record, 1, refSequence.getBytes());
    ...
    public void testDeleteAtHomologyRepeat() {
        ...
        ReadContext victium = ReadContextFactory.createDelContext("ATCA", 1000, 1, record, 1, refSequence.getBytes());
    ...
    public void testDeleteOneBase() {
        ...
        ReadContext victium = ReadContextFactory.createDelContext("GA", 1000, 0, record, 0, refSequence.getBytes());
    ...
    public void testDeleteTwoBase() {
        ...
        ReadContext victium = ReadContextFactory.createDelContext("GAT", 1000, 0, record, 0, refSequence.getBytes());
