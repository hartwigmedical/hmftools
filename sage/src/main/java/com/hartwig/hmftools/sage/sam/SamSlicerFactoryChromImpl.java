...
public class SamSlicerFactoryChromImpl implements SamSlicerFactory {

    private final SageConfig config;
    private final List<GenomeRegion> panel;

    public SamSlicerFactoryChromImpl(@NotNull final SageConfig config, @NotNull final List<GenomeRegion> panel) {
        this.config = config;
        this.panel = panel;
    }
