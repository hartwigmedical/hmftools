...
public interface GeneRegionViewModel
{
    ...
    record AminoAcidViewModel(BaseRegion region, int aminoAcidPos, char ref, char alt, int basesBeforeRightInsert, boolean isStart) implements GeneRegionViewModel
    {
