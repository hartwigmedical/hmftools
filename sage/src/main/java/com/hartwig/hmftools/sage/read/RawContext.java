...
public class RawContext {
    ...
    static RawContext clipped(final int readIndex) {
        return new RawContext(readIndex, false, false, false, false, false, 0, 0);
    }

    @NotNull
    static RawContext inDelete(final int readIndex) {
        return new RawContext(readIndex, true, false, false, false, false, 0, 0);
    }

    @NotNull
    static RawContext inSkipped(final int readIndex) {
        return new RawContext(readIndex, false, true, false, false, false, 0, 0);
    }

    @NotNull
    static RawContext indel(final int readIndex, final boolean altSupport, final int quality) {
        return new RawContext(readIndex, false, false, altSupport, false, true, altSupport ? quality : 0, 0);
    }

    @NotNull
    static RawContext snv(final int readIndex, final boolean altSupport, final boolean refSupport, final int quality) {
        return new RawContext(readIndex, false, false, altSupport, refSupport, true, altSupport ? quality : 0, refSupport ? quality : 0);
    }

    public RawContext(final int readIndex, final boolean readIndexInDelete, final boolean readIndexInSkipped, final boolean altSupport,
            final boolean refSupport, final boolean depthSupport, final int altQuality, final int refQuality) {
