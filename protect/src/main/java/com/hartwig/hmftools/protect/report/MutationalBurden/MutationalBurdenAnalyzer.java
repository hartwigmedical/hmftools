package com.hartwig.hmftools.protect.report.MutationalBurden;
...
public final class MutationalBurdenAnalyzer {
    ...
    public static double determineTumorMutationalBurden(@NotNull List<? extends SomaticVariant> variants) {
