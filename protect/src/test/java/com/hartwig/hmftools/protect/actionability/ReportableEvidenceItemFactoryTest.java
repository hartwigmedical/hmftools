...
public class ReportableEvidenceItemFactoryTest {
    ...
    public void higherLevelWorks() {
        EvidenceItem item1 = ProtectTestFactory.createTestEvidenceBuilder().level(EvidenceLevel.LEVEL_A).build();
        EvidenceItem item2 = ProtectTestFactory.createTestEvidenceBuilder().level(EvidenceLevel.LEVEL_B).build();
    ...
    public void canSelectHighest() {
        EvidenceItem item1 = ProtectTestFactory.createTestEvidenceBuilder().level(EvidenceLevel.LEVEL_A).isOnLabel(true).build();
        EvidenceItem item2 = ProtectTestFactory.createTestEvidenceBuilder().level(EvidenceLevel.LEVEL_B).isOnLabel(false).build();
        EvidenceItem item3 = ProtectTestFactory.createTestEvidenceBuilder().level(EvidenceLevel.LEVEL_C).isOnLabel(false).build();
    ...
    public void canFilterCorrectlyOnEvidenceLevel() {
        EvidenceItem item1 = ProtectTestFactory.createTestEvidenceBuilder().level(EvidenceLevel.LEVEL_A).build();
        EvidenceItem item2 = ProtectTestFactory.createTestEvidenceBuilder().level(EvidenceLevel.LEVEL_B).build();
        EvidenceItem item3 = ProtectTestFactory.createTestEvidenceBuilder().level(EvidenceLevel.LEVEL_C).build();
        EvidenceItem item4 = ProtectTestFactory.createTestEvidenceBuilder().level(EvidenceLevel.LEVEL_D).build();
        EvidenceItem item5 = ProtectTestFactory.createTestEvidenceBuilder().level(EvidenceLevel.LEVEL_E).build();
