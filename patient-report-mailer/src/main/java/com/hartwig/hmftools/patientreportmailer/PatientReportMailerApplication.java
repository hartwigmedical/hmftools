...
public class PatientReportMailerApplication {
    ...
    private static final String CENTER_FILE_PATH = "center_csv";
    ...
    public static void main(final String... args)
        ...
        final String centerPath = cmd.getOptionValue(CENTER_FILE_PATH);
        ...
        if (reportPath == null || centerPath == null || (reportPath.startsWith("DRUP") && drupEmail == null) || sender == null) {
        ...
        final String recipients = getRecipients(reportPath, centerPath, drupEmail);
    ...
    private static Options createOptions() {
        ...
        options.addOption(CENTER_FILE_PATH, true, "Path towards the cpct center file");
    ...
    @NotNull
    @VisibleForTesting
    static String getRecipients(@NotNull final String reportPath, @NotNull final String centerPath, @NotNull final String drupEmail)
        ...
        if (sample.startsWith("DRUP")) {
            final String recipients = centerModel.getDrupRecipientsFromSample(sample);
            ...
            final String recipients = centerModel.getCpctRecipientsFromSample(sample);
            if (recipients == null || recipients.isEmpty()) {
