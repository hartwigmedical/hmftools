...
public class GnomadAnnotation extends AnnotationData implements Callable
{
    ...
    public void annotateVariant(final VariantData variant, final GnomadChrCache chrCache, final boolean canBePonFiltered)
    {
        ...
        if(gnomadFreq != null)
        {
            ...
            if(canBePonFiltered && exceedsPonThreshold(gnomadFreq))
