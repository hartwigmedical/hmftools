    ...
    public static List<SequenceCountDiff> create(final SequenceCount referenceCount, final SequenceCount tumorCount)
    {
        ...
        for(int locus : loci)
        {
            ...
            if(inRef)
            {
                ...
                Map<String, Integer> tumorSeqCounts = inTum ? tumorCount.get(locus) : Collections.emptyMap();
            ...
            if(inTum)
            {
                ...
                Map<String, Integer> refSeqCounts = inRef ? referenceCount.get(locus) : Collections.emptyMap();
