...
import static com.hartwig.hmftools.lilac.LilacConstants.DEFAULT_MIN_DEPTH_FILTER_;
import static com.hartwig.hmftools.lilac.LilacConstants.DEFAULT_MIN_EVIDENCE_FACTOR_;
import static com.hartwig.hmftools.lilac.LilacConstants.DEFAULT_MIN_EVIDENCE_SUPPORT_;
import static com.hartwig.hmftools.lilac.LilacConstants.DEFAULT_MIN_HIGH_QUAL_EVIDENCE_FACTOR_;
...
public class LilacConfig
{
    ...
    public final int MinEvidenceSupport_;
    public final double MinEvidenceFactor_;
    public final double MinHighQualEvidenceFactor_;
    public final int MinDepthFilter_;
    ...
    private static final String MIN_EVIDENCE_FACTOR_ = "min_evidence_factor";
    private static final String MIN_HIGH_QUAL_EVIDENCE_FACTOR_ = "min_high_qual_evidence_factor";
    private static final String MIN_EVIDENCE_SUPPORT_ = "min_evidence_support";
    private static final String MIN_DEPTH_FILTER_ = "min_depth_filter";
    ...
    public LilacConfig(final ConfigBuilder configBuilder)
    {
        ...
        MinEvidenceFactor_ = configBuilder.getDecimal(MIN_EVIDENCE_FACTOR_);
        MaxRefFragments = configBuilder.getInteger(MAX_REF_FRAGMENTS);
        MinHighQualEvidenceFactor_ = configBuilder.getDecimal(MIN_HIGH_QUAL_EVIDENCE_FACTOR_);
        MinEvidenceSupport_ = configBuilder.getInteger(MIN_EVIDENCE_SUPPORT_);
        MinDepthFilter_ = configBuilder.getInteger(MIN_DEPTH_FILTER_);
    ...
    public LilacConfig(final String sampleId)
    {
        ...
        MinEvidenceFactor_ = DEFAULT_MIN_EVIDENCE_FACTOR_;
        MinHighQualEvidenceFactor_ = DEFAULT_MIN_HIGH_QUAL_EVIDENCE_FACTOR_;
        MinEvidenceSupport_ = DEFAULT_MIN_EVIDENCE_SUPPORT_;
        MinDepthFilter_ = DEFAULT_MIN_DEPTH_FILTER_;
    ...
    public static void addConfig(final ConfigBuilder configBuilder)
    {
        ...
        configBuilder.addDecimal(MIN_EVIDENCE_FACTOR_, "Min fragment evidence required", DEFAULT_MIN_EVIDENCE_FACTOR_);
        configBuilder.addInteger(MAX_REF_FRAGMENTS, "Cap ref fragments in solution search, 0 uses all", DEFAULT_MAX_REF_FRAGMENTS);
        configBuilder.addDecimal(MIN_HIGH_QUAL_EVIDENCE_FACTOR_, "Min high-qual fragment evidence factor", DEFAULT_MIN_HIGH_QUAL_EVIDENCE_FACTOR_);
        configBuilder.addInteger(MIN_EVIDENCE_SUPPORT_, "Min fragment evidence depth", DEFAULT_MIN_EVIDENCE_SUPPORT_);
        configBuilder.addInteger(MIN_DEPTH_FILTER_, "Raw depth below which we do not filter", DEFAULT_MIN_DEPTH_FILTER_);
