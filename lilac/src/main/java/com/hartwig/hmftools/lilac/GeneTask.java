...
public class GeneTask implements Callable<Void>
{
    ...
    public final int mMinEvidenceSupport_;
            ...
            final Candidates candidateFactory, final HlaContext hlaContext)
    {
        ...
        mMinEvidenceSupport_ = aminoAcidPipeline.minEvidenceSupport_();
        mMinEvidenceFactor_ = aminoAcidPipeline.minEvidenceFactor_();
    ...
    public Void call()
    {
        ...
        PhasedEvidenceFactory phasedEvidenceFactory = new PhasedEvidenceFactory(mConfig, mMinEvidenceSupport_, mMinEvidenceFactor_);
