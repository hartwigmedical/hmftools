...
public final class NucleotideFragmentQualEnrichment
{
            ...
            int minEvidenceSupport, double minEvidenceFactor, double minHighQualEvidenceFactor, final List<Fragment> fragments, final List<Fragment> highQualFrags)
    {
        ...
        SequenceCount highQualCounts = SequenceCount.nucleotides_(minEvidenceSupport, minHighQualEvidenceFactor, highQualFrags);
        SequenceCount rawCounts = SequenceCount.nucleotides_(minEvidenceSupport, minEvidenceFactor, fragments);
    ...
    private static Fragment applyQualityFilter(final Fragment fragment, final SequenceCount highQualityCount, final SequenceCount rawCount)
    {
        ...
        for(Map.Entry<Integer, Nucleotide> entry : nucleotidesByLoci.entrySet())
        {
            ...
            List<String> highQualitySequences = highQualityCount.getMinEvidenceSequences_(locus, DEFAULT_MIN_HIGH_QUAL_EVIDENCE_FACTOR_);
            List<String> rawSequences = rawCount.getMinEvidenceSequences_(locus, DEFAULT_MIN_EVIDENCE_FACTOR_);
