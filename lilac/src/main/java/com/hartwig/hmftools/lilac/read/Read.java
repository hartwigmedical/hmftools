...
public class Read
{
    ...
    public final int maxValidIndelSize()
    {
    ...
    public final boolean containsValidIndel() { return !mValidIndels.isEmpty(); }
        ...
        CigarHandler cigarHandler = new CigarHandler()
        {
            public void handleInsert(final SAMRecord record, final CigarElement element, int readIndex, int refPosition)
            {
                if(startPosition <= refPosition && refPosition <= endPosition)
                {
                    ...
                    indels.add(Indel.create(record.getContig(), refPosition, readIndex, String.valueOf(baseChar),
            ...
            public void handleDelete(final SAMRecord record, final CigarElement element, int readIndex, int refPosition)
            {
                if(startPosition <= refPosition && refPosition <= endPosition)
                {
                    ...
                    indels.add(Indel.create(record.getContig(), refPosition, readIndex, delBases, String.valueOf(baseChar), ignore));
                }
            }
        };
