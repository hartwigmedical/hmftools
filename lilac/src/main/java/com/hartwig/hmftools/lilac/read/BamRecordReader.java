...
{
    private final Map<HlaGene_, GeneCodingRegions> mGeneCodingRegions;
    ...
    private Map<String, Fragment> createFragments(final HlaGene_ geneName, final byte geneStrand, final Iterable<Read> codingRecords)
    {
