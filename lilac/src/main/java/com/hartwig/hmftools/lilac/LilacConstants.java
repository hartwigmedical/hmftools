...
public final class LilacConstants
{
    ...
    public static final double DEFAULT_MIN_EVIDENCE_FACTOR_ = 0.006;
    public static final double DEFAULT_MIN_HIGH_QUAL_EVIDENCE_FACTOR_ = 0.003;
    public static final int DEFAULT_MIN_EVIDENCE_SUPPORT_ = 1;
    // TODO: implememt this
    public static final int DEFAULT_MIN_DEPTH_FILTER_ = 10;
