...
import com.hartwig.hmftools.lilackt.LilacApplication.Companion.logger
...
import com.hartwig.hmftools.lilackt.hla.HlaContextFactory
import com.hartwig.hmftools.lilackt.nuc.NucleotideFragment
import com.hartwig.hmftools.lilackt.nuc.NucleotideFragmentFactory
import com.hartwig.hmftools.lilackt.nuc.NucleotideGeneEnrichment
import com.hartwig.hmftools.lilackt.out.HlaOut
import com.hartwig.hmftools.lilackt.qc.*
import com.hartwig.hmftools.lilackt.read.FragmentAlleles
import com.hartwig.hmftools.lilackt.read.SAMRecordReader
import com.hartwig.hmftools.lilackt.seq.HlaSequenceFile
import com.hartwig.hmftools.lilackt.seq.HlaSequenceFile.reduceToFourDigit
import com.hartwig.hmftools.lilackt.seq.HlaSequenceFile.reduceToSixDigit
import com.hartwig.hmftools.lilackt.seq.HlaSequenceLoci
import com.hartwig.hmftools.lilackt.seq.HlaSequenceLociFile
import com.hartwig.hmftools.lilackt.variant.LilacVCF
import com.hartwig.hmftools.lilackt.variant.SomaticAlleleCoverage
...
import com.hartwig.hmftools.lilackt.variant.SomaticVariants
...
class LilacApplication(private val cmd: CommandLine, private val config: LilacConfig) : AutoCloseable, Runnable {
    ...
    override fun run() {
        ...
        val stopLossRecovery = if (referenceBamReader.stopLossOnCIndels() > 0 && missingStopLossAlleles.isNotEmpty()) {
            logger.info("Identified ${referenceBamReader.stopLossOnCIndels()} stop loss fragments")
            logger.info("    recovered stop loss candidates: " + missingStopLossAlleles.joinToString(","))
