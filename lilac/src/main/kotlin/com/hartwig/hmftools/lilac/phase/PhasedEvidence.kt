...
data class PhasedEvidence(val indices: IntArray, val aminoAcids: CharArray, val evidence: Int) {

    companion object {

        fun evidence(minQual: Int, fragments: List<Fragment>, vararg indices: Int): List<PhasedEvidence> {
            ...
            return aminoAcidEvidence.entries.map { (aminoAcids, count) -> PhasedEvidence(indices, aminoAcids.toCharArray(), count) }
        }
