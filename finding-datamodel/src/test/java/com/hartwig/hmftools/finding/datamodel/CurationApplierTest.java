...
import static com.hartwig.hmftools.finding.datamodel.TestFindingRecordFactory.createMinimalTestFindingRecordBuilder;
...
public class CurationApplierTest
{
    ...
    public void applyWithNoCurationsReturnsUnchangedRecord()
    {
        ...
        FindingRecord record = createMinimalTestFindingRecordBuilder()
                .somaticSmallVariants(TestFindingFactory.buildDriverFindingsList(ResultStatus.OK, List.of(variant)))
                .build();
    ...
    public void applyCurationDoesNotAffectUnmatchedFindings()
    {
        ...
        SmallVariant variant2 = TestFindingFactory.variantBuilder()
                ...
                .build();
        FindingRecord record = createMinimalTestFindingRecordBuilder()
                .somaticSmallVariants(TestFindingFactory.buildDriverFindingsList(ResultStatus.OK, List.of(variant1, variant2)))
                .build();
    ...
    public void applyCurationToGainDeletion()
    {
        GainDeletion gd = TestFindingFactory.gainDeletionBuilder()
                ...
                .build();
        FindingRecord record = createMinimalTestFindingRecordBuilder()
                .somaticGainDeletions(TestFindingFactory.buildDriverFindingsList(ResultStatus.OK, List.of(gd)))
                .build();
    ...
    public void applyCurationToDisruption()
    {
        Disruption disruption = TestFindingFactory.disruptionBuilder()
                ...
                .build();
        FindingRecord record = createMinimalTestFindingRecordBuilder()
                .somaticDisruptions(TestFindingFactory.buildDriverFindingsList(ResultStatus.OK, List.of(disruption)))
                .build();
    ...
    public void applyCurationToFusion()
    {
        Fusion fusion = TestFindingFactory.fusionBuilder()
                ...
                .build();
        FindingRecord record = createMinimalTestFindingRecordBuilder()
                .fusions(TestFindingFactory.buildDriverFindingsList(ResultStatus.OK, List.of(fusion)))
                .build();
    ...
    public void applyCurationToGermlineList()
    {
        SmallVariant variant = TestFindingFactory.variantBuilder()
                ...
                .build();
        FindingRecord record = createMinimalTestFindingRecordBuilder()
                .germlineSmallVariants(TestFindingFactory.buildDriverFindingsList(ResultStatus.OK, List.of(variant)))
                .build();
