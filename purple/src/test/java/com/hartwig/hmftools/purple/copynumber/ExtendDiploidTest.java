...
public class ExtendDiploidTest
{
    ...
    {
        ObservedRegion dubious1 = createDubiousRegion(1, 50000, 2, 10, 0);
        ObservedRegion dubious2 = createDubiousRegion(50001, 60000, 3, 20, 0);

        List<CombinedRegion> result = PURE_VICTIM.extendDiploid(Lists.newArrayList(dubious1, dubious2));
    ...
    {
        ObservedRegion valid = createValidSomatic(1, 10000, 1, 1, SegmentSupport.TELOMERE);
        ObservedRegion dubiousCentromere = createRegion(10001, 20000, 4, 8, 0, SegmentSupport.CENTROMERE);
        ObservedRegion dubious1 = createRegion(20001, 30000, 4, 9, 0, SegmentSupport.NONE);
        ObservedRegion dubious2 = createRegion(30001, 40000, 4, 10, 0, SegmentSupport.NONE);

        List<CombinedRegion> result = PURE_VICTIM.extendDiploid(Lists.newArrayList(valid, dubiousCentromere, dubious1, dubious2));
    ...
    {
        ObservedRegion somaticLeft = createValidSomatic(1, 10000, 3.0, 50, SegmentSupport.BND);
        ObservedRegion dubious = createDubiousRegion(10001, 20000, 2.0, 10);
        ObservedRegion somaticRight = createValidSomatic(20001, 30000, 3.0, 40, SegmentSupport.NONE);

        List<CombinedRegion> result = PURE_VICTIM.extendDiploid(Lists.newArrayList(somaticLeft, dubious, somaticRight));
        assertEquals(1, result.size());
    ...
    {
        ObservedRegion somaticLeft = createValidSomatic(1, 10000, 3.0, 30, SegmentSupport.BND);
        ObservedRegion dubious = createDubiousRegion(10001, 20000, 2.0, 10);
        ObservedRegion somaticRight = createValidSomatic(20001, 30000, 3.0, 40, SegmentSupport.NONE);
    ...
    public void testDubiousRegionGetsExcludedBecauseOfSV()
    {
        ObservedRegion somaticLeft = createValidSomatic(1, 10000, 3.0, 50, SegmentSupport.BND);
        ObservedRegion dubious = createDubiousRegion(10001, 20000, 2.0, 10);
        ObservedRegion somaticRight = createValidSomatic(20001, 30000, 3.0, 40, SegmentSupport.BND);
    ...
    {
        ObservedRegion somaticLeft = createValidSomatic(1, 10000, 3.0, 50, SegmentSupport.BND);
        ObservedRegion dubious1 = createDubiousRegion(10001, 11000, 2.0, 20);
        ObservedRegion dubious2 = createDubiousRegion(11001, 12000, 2.0, 9);
        ObservedRegion dubious3 = createDubiousRegion(12001, 20000, 2.0, 20);
        ObservedRegion somaticRight = createValidSomatic(20001, 30000, 3.0, 40, SegmentSupport.NONE);

        List<CombinedRegion> result =
    ...
    public void testDubiousRegionGetsExcludedBecauseOfTooManyConsecutiveRatioCounts()
    {
        ObservedRegion somaticLeft = createValidSomatic(1, 10000, 3.0, 50, SegmentSupport.BND);
        ObservedRegion dubious1 = createDubiousRegion(10001, 11000, 2.0, 20);
        ObservedRegion dubious2 = createDubiousRegion(11001, 12000, 2.0, 10);
        ObservedRegion dubious3 = createDubiousRegion(12001, 20000, 2.0, 20);
        ObservedRegion somaticRight = createValidSomatic(20001, 30000, 3.0, 40, SegmentSupport.NONE);
    ...
    {
        ObservedRegion somaticLeft = createValidSomatic(1, 10000, 3.0, 50, SegmentSupport.BND);
        ObservedRegion dubious1 = createDubiousRegion(10001, 11000, 2.0, 11);
        ObservedRegion dubious2 = createDubiousRegion(11001, 12000, 2.0, 11);
        ObservedRegion dubious3 = createDubiousRegion(12001, 20000, 2.0, 11);
        ObservedRegion somaticRight = createValidSomatic(20001, 30000, 3.0, 40, SegmentSupport.CENTROMERE);
    ...
    {
        ObservedRegion somaticLeft = createValidSomatic(1, 10000, 3.0, 50, SegmentSupport.BND);
        ObservedRegion dubious1 = createDubiousRegion(10001, 11000, 2.0, 21);
        ObservedRegion dubious2 = createDubiousRegion(11001, 12000, 2.0, 21);
        ObservedRegion dubious3 = createDubiousRegion(12001, 20000, 2.0, 21);
        ObservedRegion somaticRight = createValidSomatic(20001, 30000, 3.0, 40, SegmentSupport.CENTROMERE);
    ...
    {
        ObservedRegion somatic = createFittedRegion(1, 10000, 3.0, GermlineStatus.DIPLOID, SegmentSupport.BND);
        ObservedRegion germline = createFittedRegion(10001, 20000, 4, GermlineStatus.AMPLIFICATION, SegmentSupport.NONE);
        List<ObservedRegion> regions = Lists.newArrayList(somatic, germline);

        List<CombinedRegion> result = PURE_VICTIM.extendDiploid(regions);
        assertEquals(1, result.size());
        assertRegion(1, 20000, 3, result.get(0));
    }
    ...
    {
        ObservedRegion somatic = createFittedRegion(1, 10000, 3.0, GermlineStatus.DIPLOID, SegmentSupport.BND);
        ObservedRegion germline = createFittedRegion(10001, 20000, 4.0, GermlineStatus.AMPLIFICATION, SegmentSupport.BND);
        List<ObservedRegion> regions = Lists.newArrayList(somatic, germline);
    ...
    private static ObservedRegion createRegion(
            int start, int end, double copyNumber, int ratioCount, int bafCount, final SegmentSupport support)
    {
        ObservedRegion region = createDefaultFittedRegion(CHROMOSOME, start, end);
        region.setGermlineStatus(GermlineStatus.DIPLOID);
        region.setTumorCopyNumber(copyNumber);
    ...
    private static ObservedRegion createFittedRegion(
            int start, int end, double tumorCopyNumber, double observedNormalRatio, final GermlineStatus status, SegmentSupport support)
    {
        ObservedRegion region = createDefaultFittedRegion(CHROMOSOME, start, end);
