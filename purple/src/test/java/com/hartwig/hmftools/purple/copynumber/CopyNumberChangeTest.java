...
import com.hartwig.hmftools.purple.copynumber.sv.SvCopyNumberChange;
...
public class CopyNumberChangeTest
{
    ...
    public void testTwoPositiveOrientationsHaveNoCopyNumberChange()
    {
        ...
        final SvCopyNumberChange victim = new SvCopyNumberChange(legList);
    ...
    {
        return StructuralVariantPloidyFactoryTest.svLegPloidy(
                CHROMOSOME, orientation, Optional.of(leftCopyNumber), Optional.of(rightCopyNumber), ploidy);
    }
}
