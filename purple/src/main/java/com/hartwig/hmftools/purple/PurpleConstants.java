...
public class PurpleConstants
{
    ...
    public static final int MIN_DIPLOID_TUMOR_RATIO_COUNT_DEFAULT = 0; // default 30
    public static final int MIN_DIPLOID_TUMOR_RATIO_COUNT_AT_CENTROMERE_DEFAULT = 0; // default 150
