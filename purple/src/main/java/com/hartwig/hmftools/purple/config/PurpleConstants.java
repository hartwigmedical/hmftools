...
public class PurpleConstants
{
    ...
    public static final double BIALLELIC_THRESHOLD_PARAMETER = 1.5; // potential change to 1.2
    public static final double BIALLELIC_LOH_BASE_ERROR_RATE = 0.01; // potential change to 0.02
}
