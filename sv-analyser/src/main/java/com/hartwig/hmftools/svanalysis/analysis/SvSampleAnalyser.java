    ...
    private void writeClusterData()
    {
        try
        {
            if(mClusterFileWriter == null)
            {
                ...
                mClusterFileWriter.write(",AcFbPairSame,AcFbPairOpp,AcFbPairFacing,AcComplexFb,AcComplexLine,AcComplexOther");
                ...
                for (final SvChain chain : chains)
                {
                    ...
                    for (final SvLinkedPair pair : chain.getLinkedPairs())
                    {
                        ...
                        writer.write(String.format(",%s,%d,%d,%d,%d,%d,%d,%s,%s,%d,%s",
                                ...
                                pair.getNextSVDistance(), pair.getTraversedSVCount(),
