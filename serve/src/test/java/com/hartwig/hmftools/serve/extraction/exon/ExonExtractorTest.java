...
public class ExonExtractorTest {
    ...
    public void canFilterInCatalog() {
        ...
        ExonExtractor exonExtractorFilter =
                createWithDriverGenes(DriverGeneTestFactory.createDriverGenes("TP53", "KIT"), DriverInconsistencyMode.FILTER);
        ...
        ExonExtractor exonExtractorWarn =
                createWithDriverGenes(DriverGeneTestFactory.createDriverGenes("TP53", "KIT"), DriverInconsistencyMode.WARN_ONLY);
    ...
    public void canExtractExonForwardStrand() {
        ExonExtractor extractor =
                createWithDriverGenes(DriverGeneTestFactory.createDriverGenes("TP53", "EGFR"), DriverInconsistencyMode.IGNORE);
