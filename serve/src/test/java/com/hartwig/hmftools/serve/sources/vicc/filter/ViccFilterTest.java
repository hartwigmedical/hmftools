...
public class ViccFilterTest {
    ...
    public void canFilterOncogenicEvents() {
        ViccEntry oncogenic = ViccTestFactory.testViccEntryWithOncogenic("Oncogenic", "gene", "event", "description","chromosome", "pos", null);
        ViccEntry benign = ViccTestFactory.testViccEntryWithOncogenic("Inconclusive", "gene", "event", "description","chromosome", "pos", null);
    ...
    public void canFilterIndividualFeatures() {
        ...
        Feature featureWithFilterKeyword = ViccTestFactory.testFeatureWithName(keywordToFilter + " filter me", "description","chromosome", "pos", null);
        ...
        Feature featureWithFilterName = ViccTestFactory.testFeatureWithName(nameToFilter + " filter me", "description","chromosome", "pos", null);
        ...
        Feature featureToFilter = ViccTestFactory.testFeatureWithGeneAndName(keyToFilter.gene(), keyToFilter.name(), "description","chromosome", "pos", null);
