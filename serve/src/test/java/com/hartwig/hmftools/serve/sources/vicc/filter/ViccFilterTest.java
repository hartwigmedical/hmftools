...
public class ViccFilterTest {
    ...
    public void canFilterOncogenicEvents() {
        ViccEntry oncogenic = ViccTestFactory.testViccEntryWithOncogenic("Oncogenic", "gene", "event", "description","chromosome", "pos");
        ViccEntry benign = ViccTestFactory.testViccEntryWithOncogenic("Inconclusive", "gene", "event", "description","chromosome", "pos");
    ...
    public void canFilterIndividualFeatures() {
        ...
        Feature featureWithExactKeyword = ViccTestFactory.testFeatureWithName(keywordToFilter, "description","chromosome", "pos");
        Feature featureWithFilterKeyword = ViccTestFactory.testFeatureWithName(keywordToFilter + " filter me", "description","chromosome", "pos");
        ...
        Feature featureWithExactName = ViccTestFactory.testFeatureWithName(nameToFilter,"description", "chromosome", "pos");
        Feature featureWithFilterName = ViccTestFactory.testFeatureWithName(nameToFilter + " filter me", "description","chromosome", "pos");
        ...
        Feature featureToFilter = ViccTestFactory.testFeatureWithGeneAndName(keyToFilter.gene(), keyToFilter.name(), "description","chromosome", "pos");
        assertFalse(filter.include(keyToFilter.source(), featureToFilter));

        Feature featureWithoutFilterName = ViccTestFactory.testFeatureWithName("don't filter me", "description","chromosome", "pos");
