    ...
    //
        ...
        public static String curatedFusions(@NotNull String fusion) {
            if (fusion.equals("ZNF198-FGFR1")) {
                ...
                fusion = "PAX8-PPARA";
//            } else if (fusion.contains("IGH") || fusion.contains("IGK") || fusion.contains("TRB") || fusion.contains("Delta")
//                    || fusion.equals("RET-TPCN1") || fusion.equals("PVT1-MYC") || fusion.equals("ESR1-CCDC170") || fusion.equals("BRAF-CUL1")
