...
public final class FeatureIgnoreUtil {
    ...
    static {
        ...
        FEATURE_KEYWORDS_TO_IGNORE.add("G606FS*2");
        FEATURE_KEYWORDS_TO_IGNORE.add("K159FS*16");
        FEATURE_KEYWORDS_TO_IGNORE.add("K383Rfs*32");
        FEATURE_KEYWORDS_TO_IGNORE.add("K442Nfs*");
        FEATURE_KEYWORDS_TO_IGNORE.add("K706FS*19");
        FEATURE_KEYWORDS_TO_IGNORE.add("L531FS*30");
        FEATURE_KEYWORDS_TO_IGNORE.add("M54Ifs (c.162_166delGGAGG)");
        FEATURE_KEYWORDS_TO_IGNORE.add("M695FS*26");
        FEATURE_KEYWORDS_TO_IGNORE.add("N1068fs*4");
        FEATURE_KEYWORDS_TO_IGNORE.add("N1333Gfs*");
        FEATURE_KEYWORDS_TO_IGNORE.add("P291Qfs*51");
        FEATURE_KEYWORDS_TO_IGNORE.add("Q2405Rfs*17");
        FEATURE_KEYWORDS_TO_IGNORE.add("R177Pfs*126");
        FEATURE_KEYWORDS_TO_IGNORE.add("R259fs*15");
        FEATURE_KEYWORDS_TO_IGNORE.add("UGT1A1*28");
