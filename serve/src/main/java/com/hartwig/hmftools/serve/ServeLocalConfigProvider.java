...
public final class ServeLocalConfigProvider {
    ...
    public static ServeConfig create() throws IOException {
        ...
        if (hostname.toLowerCase().contains("serve-vm")) {
            ...
            builder.ckbDrugCurationFilterTsv("/data/resources/crunch/serve/curation/ckb_drugs_class_curation_filter.tsv");
            ...
            builder.ckbDrugCurationFilterTsv(baseDir + "serve/curation/ckb_drugs_class_curation_filter.tsv");
