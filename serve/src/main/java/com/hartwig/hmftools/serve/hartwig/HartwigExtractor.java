...
public class HartwigExtractor {
    ...
    private final boolean addImpliedHotspots;

    public HartwigExtractor(@NotNull final ProteinToHotspotConverter proteinToHotspotConverter, final boolean addImpliedHotspots) {
        this.proteinToHotspotConverter = proteinToHotspotConverter;
        this.addImpliedHotspots = addImpliedHotspots;
    }
