...
from gene
    ...
    inner join xref as entrez_xref on (entrez_xref.xref_id=object_xref.xref_id and entrez_xref.external_db_id = 1300 and entrez_xref.display_label = display_xref.display_label)
...
group by chromosome, gene_start, gene_end, gene_id, gene_name, entrezId, transcript_id, transcript_version, transcript_start, transcript_end, exon_id, exon_start, exon_end
