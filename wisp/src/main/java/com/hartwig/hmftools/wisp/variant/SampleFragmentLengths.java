...
import static com.hartwig.hmftools.wisp.FileType.FRAGMENT_LENGTHS;
...
public class SampleFragmentLengths
{
    ...
    public SampleFragmentLengths(final WispConfig config, final ResultsWriter resultsWriter, final SampleData sample)
    {
        mConfig = config;
    ...
    public static BufferedWriter initialiseFragmentLengthWriter(final WispConfig config)
    {
        try
        {
