...
import static com.hartwig.hmftools.wisp.WispConstants.LOW_COUNT_MODEL_MIN_2_PLUS_FRAGS;
import static com.hartwig.hmftools.wisp.WispConstants.LOW_COUNT_MODEL_MIN_2_PLUS_FRAG_PERC;
import static com.hartwig.hmftools.wisp.WispConstants.LOW_COUNT_MODEL_MIN_AVG_DEPTH;
import static com.hartwig.hmftools.wisp.WispConstants.LOW_COUNT_MODEL_MIN_FRAG_VARIANTS;
...
public class LowCountModel extends ClonalityModel
{
    ...
    public void calculate(final String sampleId, final FragmentTotals fragmentTotals, final PurityCalcData purityCalcData, double noiseRate)
    {
        ...
        double purityEstimate = SomaticPurityCalcs.cappedPurity(SomaticPurityCalcs.estimatedPurity(
        ...
        if(purityEstimate != INVALID_PURITY)
        {
            ...
            purityCalcData.PurityRangeLow = SomaticPurityCalcs.cappedPurity(SomaticPurityCalcs.estimatedPurity(
                    purityCalcData.Clonality.VafLow, noiseRate, fragmentTotals), purityEstimate);

            purityCalcData.PurityRangeHigh = SomaticPurityCalcs.cappedPurity(SomaticPurityCalcs.estimatedPurity(
    ...
    private ClonalityResult calcClonalityData(final String sampleId, final FragmentTotals fragmentTotals)
    {
        ...
        for(double dropoutRate = 0; dropoutRate < 0.95; dropoutRate += WispConstants.DROPOUT_RATE_INCREMENT)
        {
