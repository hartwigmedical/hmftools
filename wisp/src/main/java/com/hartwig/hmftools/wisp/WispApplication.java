...
import static com.hartwig.hmftools.wisp.WriteType.plotCopyNumber;
import static com.hartwig.hmftools.wisp.WriteType.plotSomatics;
...
import com.hartwig.hmftools.wisp.copynumber.CopyNumberProfile;
import com.hartwig.hmftools.wisp.loh.AmberLohCalcs;
import com.hartwig.hmftools.wisp.loh.AmberLohResult;
import com.hartwig.hmftools.wisp.variant.SomaticPurityResult;
import com.hartwig.hmftools.wisp.variant.SomaticVariants;
import com.hartwig.hmftools.wisp.variant.SomaticWriter;
...
public class WispApplication
{
    ...
    public WispApplication(final ConfigBuilder configBuilder)
    {
        mConfig = new WispConfig(configBuilder);
    ...
    public static void main(final String[] args)
    {
        ...
        WispConfig.addConfig(configBuilder);

        ConfigUtils.addLoggingOptions(configBuilder);

        configBuilder.checkAndParseCommandLine(args);

        WispApplication wispApplication = new WispApplication(configBuilder);
        wispApplication.run();
    }
}
