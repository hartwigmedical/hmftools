...
import static com.hartwig.hmftools.wisp.FileType.SOMATICS;
import static com.hartwig.hmftools.wisp.FileType.SOMATIC_PEAK;
import static com.hartwig.hmftools.wisp.FileType.SUMMARY;
...
{
    public static BufferedWriter initialiseVariantWriter(final WispConfig config)
    {
        try
        {
    ...
    public static boolean plotSomaticVafs(final String patientId, final String sampleId, final WispConfig config)
    {
        try
        {
