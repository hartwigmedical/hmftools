package com.hartwig.hmftools.wisp.loh;
...
import static com.hartwig.hmftools.wisp.FileType.AMBER_LOH;
import static com.hartwig.hmftools.wisp.WispConstants.AMBER_LOH_CN_THRESHOLD;
import static com.hartwig.hmftools.wisp.WispConstants.AMBER_LOH_MINOR_ALLELE_THRESHOLD;
import static com.hartwig.hmftools.wisp.WispConstants.AMBER_LOH_MIN_AF;
import static com.hartwig.hmftools.wisp.WispConstants.AMBER_LOH_MIN_TUMOR_BAF;
import static com.hartwig.hmftools.wisp.WispConstants.AMBER_LOH_PEAK_PROBABILITY;
import static com.hartwig.hmftools.wisp.WispConstants.AMBER_LOH_PEAK_PURITY_MIN;
import static com.hartwig.hmftools.wisp.WispConstants.AMBER_LOH_PEAK_PURITY_FACTOR;
import static com.hartwig.hmftools.wisp.WispConstants.AMBER_LOH_PEAK_SITE_MIN_COUNT;
import static com.hartwig.hmftools.wisp.WispConstants.AMBER_LOH_PEAK_SITE_PERC;
...
public class AmberLohCalcs
{
    ...
    public AmberLohCalcs(final WispConfig config, final ResultsWriter resultsWriter, final SampleData sample)
    {
        mConfig = config;
    ...
    public AmberLohResult processSample(final String sampleId)
    {
        try
        {
            ...
            double lohLod = LodCalcs.calcLimitOfDetection(LOW_PROBABILITY, lohMeanCN, totalLohSupportCount);
    ...
    public static BufferedWriter initialiseAmberLohWriter(final WispConfig config)
    {
        try
        {
