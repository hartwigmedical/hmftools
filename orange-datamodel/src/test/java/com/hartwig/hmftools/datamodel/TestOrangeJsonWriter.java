...
public class TestOrangeJsonWriter
{
        ...
        return ImmutableOrangeRecord.builder()
                ...
                .chord(ImmutableChordRecord.builder()
                        .homologousRecombination(
                                ImmutableHomologousRecombination.builder()
                                        .findingKey("homologousRecombination[HR_PROFICIENT]")
                                        .hrdValue(0.01)
        ...
        return ImmutablePurpleRecord.builder()
                ...
                .characteristics(ImmutablePurpleCharacteristics.builder()
                        ...
                        .microsatelliteStability(ImmutableMicrosatelliteStability.builder()
                                .findingKey("microsatelliteStability[MSS]")
                        ...
                        .tumorMutationStatus(ImmutableTumorMutationStatus.builder()
                                .findingKey("tumorMutationStatus")
                ...
                .germlineDrivers(List.of(ImmutablePurpleDriver.builder()
                        ...
                        .isCanonical(false)
                        .build()))
                .driverSomaticVariants(List.of(somaticVariant))
                .otherSomaticVariants(List.of(somaticVariant))
                .driverGermlineVariants(List.of(germlineVariant))
                .otherSomaticVariants(List.of(germlineVariant))
                ...
                .driverSomaticGainsDels(List.of(ImmutableGainDeletion.builder()
                        .findingKey("gainDeletion[SMAD4 FULL_DELL]")
    ...
    private static LinxRecord createLinxRecord()
    {
        ...
        return ImmutableLinxRecord.builder()
                .addAllSomaticStructuralVariants(ImmutableLinxSvAnnotation.builder()
                        .vcfId("id")
                        .svId(1)
                        .clusterId(2)
                        .clusterReason("")
                        ...
                        .localTICountEnd(4)
                        .build())
                .addAllSomaticFusions(ImmutableFusion.builder()
                        .findingKey("fusion[TMPRSS2-ETV4]")
                        .reportedStatus(ReportedStatus.REPORTED)
                        .driverInterpretation(DriverInterpretation.HIGH)
                        ...
                        .domainsLost("")
                        .build())
                .addDriverSomaticBreakends(somaticBreakend)
    ...
    public static VirusInterpreterData createVirusInterpreterData()
    {
        ...
        return ImmutableVirusInterpreterData.builder()
                ...
                .addDriverViruses(ImmutableVirus.builder()
                        .findingKey("virus[HPV]")
                        .reportedStatus(ReportedStatus.REPORTED)
                        .driverInterpretation(DriverInterpretation.HIGH)
                        .interpreterEntry(virus1)
                        .build())
                .build();
    }
