    ...
    private static PurpleRecord createPurpleRecord()
    {
        ...
        return ImmutablePurpleRecord.builder()
                ...
                .germlineDrivers(List.of(ImmutablePurpleDriver.builder()
                        ...
                        .isCanonical(false)
                        .build()))
                .reportableSomaticVariants(List.of(somaticVariant))
                .reportableGermlineVariants(List.of(germlineVariant))
                .allSomaticCopyNumbers(List.of(ImmutablePurpleCopyNumber.builder()
                        .chromosome("1")
                        .start(10)
                        .end(20)
                ...
                .allSomaticGeneCopyNumbers(List.of(ImmutablePurpleGeneCopyNumber.builder()
                        .gene("gene")
                        .chromosome("12")
                        .chromosomeBand("p13")
                        .transcript("trans")
                ...
                .reportableSomaticGainsDels(List.of(ImmutablePurpleGainDeletion.builder()
                        ...
                        .maxCopies(1.2)
                        .build()))
                .chromosomalRearrangements(ImmutableChromosomalRearrangements.builder()
                        .hasTrisomy1q(false)
    ...
    private static LinxRecord createLinxRecord()
    {
        ...
        return ImmutableLinxRecord.builder()
                .addAllSomaticStructuralVariants(ImmutableLinxSvAnnotation.builder()
                        ...
                        .localTICountEnd(4)
                        .build())
                .addAllSomaticFusions(ImmutableLinxFusion.builder()
                        .reported(true)
                        ...
                        .domainsLost("")
                        .build())
                .addAllSomaticBreakends(somaticBreakend)
