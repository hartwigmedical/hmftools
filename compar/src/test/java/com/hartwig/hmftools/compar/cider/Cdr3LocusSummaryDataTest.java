...
import static com.hartwig.hmftools.compar.cider.Cdr3LocusSummaryComparer.FLD_PASS_SEQUENCES;
...
public class Cdr3LocusSummaryDataTest extends ComparableItemTest<Cdr3LocusSummaryData, Cdr3LocusSummaryComparer, TestCdr3LocusSummaryDataBuilder>
{
    ...
    public void setUp()
    {
        ...
        fieldToAlternateValueInitializer =
                Map.of(FLD_PASS_SEQUENCES, b -> b.passSequenceCount = alternateValueSource.Cdr3LocusSummary.passSequences());
