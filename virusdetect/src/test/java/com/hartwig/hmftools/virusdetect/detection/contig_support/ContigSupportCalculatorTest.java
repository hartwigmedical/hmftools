...
import static com.hartwig.hmftools.virusdetect.common.VirusConstants.READ_VOTE_CORRECT_BASE_PROBABILITY;
...
public class ContigSupportCalculatorTest
{
    ...
    private static ViralReadAlignment alignment(String readName, ViralContig contig, int start, int length, int alignerScore,
            int divergence)
    {
