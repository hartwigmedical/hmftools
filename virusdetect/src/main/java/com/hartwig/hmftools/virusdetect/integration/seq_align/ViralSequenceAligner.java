package com.hartwig.hmftools.virusdetect.integration.seq_align;
...
import com.hartwig.hmftools.virusdetect.app.VirusConfig;
...
public class ViralSequenceAligner
{
    ...
    public static ViralSequenceAligner create(VirusConfig config, ViralReference reference)
    {
