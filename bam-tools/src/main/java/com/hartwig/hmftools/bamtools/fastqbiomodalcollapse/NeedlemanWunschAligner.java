...
import static com.hartwig.hmftools.bamtools.fastqbiomodalcollapse.NeedlemanWunschAligner.SuffixPenaltyOption.NO_PENALTY_DUAL;
...
public class NeedlemanWunschAligner<T>
{
    ...
    public enum SuffixPenaltyOption
    {
        PENALIZE,
        NO_PENALTY_SINGLE,
        NO_PENALTY_DUAL;
