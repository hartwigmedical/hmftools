path = "/Users/jon/hmf/analysis/paddle/somatics"
...
summary = read.table(file = "/Users/jon/hmf/analysis/paddle/mutationalLoad.tsv", header = T)
...
save(allSomatics, file ="/Users/jon/hmf/analysis/paddle/rdata/allSomatics.RData")
...
save(HmfRefCDSCv, file ="/Users/jon/hmf/analysis/paddle/rdata/HmfRefCDSCv.RData")
write.table(HmfRefCDSCv, file ="/Users/jon/hmf/analysis/paddle/HmfRefCDSCv.tsv", quote = F, row.names = F, sep = "\t")
...
write.table(dndsUnfilteredAnnotatedMutations, file ="/Users/jon/hmf/analysis/paddle/DndsMutations.tsv", quote = F, row.names = F, sep = "\t")
