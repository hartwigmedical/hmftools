...
public class SampleMutationalLoad
{
    ...
    public SampleMutationalLoad(
            final int snvBiallelic, final int snvNonBiallelic, final int indelBiallelic, final int indelNonBiallelic)
    {
    ...
    public static BufferedWriter initialiseWriter(final String filename)
    {
        try
        {
            ...
            sj.add(SAMPLE_ID).add(SNV_BI).add(SNV_NON_BI).add(INDEL_BI).add(INDEL_NON_BI);
        ...
        try
        {
            ...
            for(String line : lines)
            {
                ...
                sampleMutationalLoadMap.put(sampleId, new SampleMutationalLoad(
                        Integer.parseInt(values[snvIndex]), Integer.parseInt(values[snvNbIndex]),
