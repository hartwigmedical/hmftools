...
### BED files generated by script

There 2 coding region BED files are used by SAFE to define panel regions for variant calling and coverage, and typically cover the set of genes' exonic regions only. 
...
### Files generated by training procedure

The following files are the output of the training process described in detaile below
