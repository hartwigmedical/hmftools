Oncoanalyser: Running the Hartwig pipeline
==========================================

# Table of contents

<!-- TOC -->
* [Oncoanalyser: Running the Hartwig pipeline](#oncoanalyser--running-the-hartwig-pipeline)
...
| filetype      | File type: `bam`, `fastq`, etc. See below for all valid values.                                 |
...
Valid values for column `filetype`:
- Raw inputs: `bam`, `bai`, `fastq`
- REDUX output: `bam_redux`, `redux_dup_freq_tsv`, `redux_jitter_tsv`, `redux_ms_tsv`, `redux_repeat_tsv`
- Other tool outputs:
  - `amber_dir`
  - `bamtools`
  - `bamtools_dir`
