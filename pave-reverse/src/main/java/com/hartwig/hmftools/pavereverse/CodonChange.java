...
class CodonChange implements Comparable<CodonChange>
{
    @NotNull
    ...
    CodonChange(@NotNull final String referenceCodon, @NotNull final String alternateCodon)
    {
