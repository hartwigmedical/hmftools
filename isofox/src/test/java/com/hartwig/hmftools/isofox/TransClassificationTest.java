...
public class TransClassificationTest
{
    ...
    public void testSoftClippedReadTranscriptClassification()
    {
        ...
        RegionReadData region1 = createRegion("GEN01", trans1, 1, "1", 100, 119);
        region1.setRefBases(REF_BASE_STR_1);
        RegionReadData region2 = createRegion("GEN01", trans1, 2, "1", 200, 219);
        region2.setRefBases(REF_BASE_STR_1);
        RegionReadData region3 = createRegion("GEN01", trans1, 3, "1", 300, 319);
        ...
        ReadRecord read = createReadRecord(1, "1", 200, 309, readBases, createCigar(1, 20, 80, 10, 0));
