...
public class GenerateEnsemblDataCache
{
    ...
    public static void writeEnsemblDataFiles(final CommandLine cmd)
    {
        ...
        ensemblData.writeDataCacheFiles(cmd.getOptionValue(SvaConfig.DATA_OUTPUT_DIR));
    }
    ...
    private static Options createBasicOptions()
    {
        ...
        options.addOption(SvaConfig.DATA_OUTPUT_DIR, true, "Directory to write Ensembl data files");
