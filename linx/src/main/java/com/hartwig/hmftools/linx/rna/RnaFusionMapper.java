...
import static com.hartwig.hmftools.linx.fusion.SvFusionAnalyser.checkFusionLogic;
...
public class RnaFusionMapper
{
            ...
            final GeneFusion candidateFusion, final SvBreakend beCandidateStart, final SvBreakend beCandidateEnd, final RnaFusionData rnaFusion)
    {
        ...
        double currentPosDiff = (Math.abs(rnaFusion.PositionUp - beCurrentStart.position()) + Math.abs(rnaFusion.PositionDown - beCurrentEnd.position())) * 0.5;
        double candidatePosDiff = (Math.abs(rnaFusion.PositionUp - beCandidateStart.position()) + Math.abs(rnaFusion.PositionDown - beCandidateEnd.position())) * 0.5;
