...
public class XMLPatientReaderTest {
    ...
    public void canReadPatients() throws FileNotFoundException, XMLStreamException {
        ...
        EcrfField field1 = new EcrfField("SE", "FRM", "GRP", "CATEGORY.field1", "", field1Values);
        EcrfField field2 = new EcrfField("SE", "FRM", "GRP", "CATEGORY.field2", "",
                Maps.<Integer, String>newHashMap());
        EcrfField birthDate = new EcrfField("SE", "FRM", "GRP", "CATEGORY.BIRTHDTC", "",
                Maps.<Integer, String>newHashMap());
