...
public class SpliceLiftBackEndToEndTest
{
    ...
    // Overlaps LiftBackScenarioTest#exonSpanningReadLiftsToJunctionCigar (which runs the fuller pipeline) -- candidate for consolidation.
    @Test
    ...
    // Overlaps LiftBackScenarioTest#supplementarySaTagRewrittenToGenomicCoords (which runs the fuller pipeline) -- candidate for consolidation.
    @Test
    ...
    // Overlaps LiftBackScenarioTest#unliftableReadIsMarkedUnmapped (which runs the fuller pipeline) -- candidate for consolidation.
    @Test
