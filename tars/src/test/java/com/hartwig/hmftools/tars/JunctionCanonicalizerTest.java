...
public class JunctionCanonicalizerTest
{
    ...
    // in-memory ref, 1-based inclusive coords; null outside the array (mirrors the production source).
    ...
    private static JunctionCanonicalizer canonicalizer(final byte[] ref)
    {
        return new JunctionCanonicalizer(
                refSource(Map.of(CHR1, ref)), JunctionCanonicalizer.DEFAULT_MAX_SHIFT);
    }
