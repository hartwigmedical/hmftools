...
public class ReadGroup
{
    ...
    public List<SAMRecord> getAllReads()
    {
        List<SAMRecord> allReads = new ArrayList<>(Reads);
        allReads.addAll(SupplementaryReads);
        return allReads;
    }
    ...
    public boolean invariant()
    {
        ...
        return SupplementaryReads.stream().allMatch(x -> x.getSupplementaryAlignmentFlag());
    }
    ...
    public boolean acceptRead(@NotNull SAMRecord record)
    {
        if (contains(record))
            return false;
