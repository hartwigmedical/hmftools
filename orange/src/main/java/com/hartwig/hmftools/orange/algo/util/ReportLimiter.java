...
public final class ReportLimiter
{
    ...
    private static PurpleRecord limitPurpleDataToOne(@NotNull PurpleRecord purple)
    {
        return ImmutablePurpleRecord.builder()
                ...
                .allSomaticGainsLosses(max1(purple.allSomaticGainsDels()))
                .reportableSomaticGainsLosses(max1(purple.reportableSomaticGainsDels()))
                .nearReportableSomaticGains(max1(purple.nearReportableSomaticGains()))
                .additionalSuspectSomaticGainsLosses(max1(purple.additionalSuspectSomaticGainsDels()))
                .allGermlineDeletions(max1(purple.allGermlineDeletions()))
                .allGermlineFullLosses(max1(purple.allGermlineFullDels()))
                .reportableGermlineFullLosses(max1(purple.reportableGermlineFullDels()))
