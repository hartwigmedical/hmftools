...
public class BreakendUtilTest {
    ...
    public void canCreatePairsPerSv() {
        LinxBreakend breakend1 = LinxTestFactory.breakendBuilder().svId(1).build();
        LinxBreakend breakend2 = LinxTestFactory.breakendBuilder().svId(1).build();
        LinxBreakend breakend3 = LinxTestFactory.breakendBuilder().svId(2).build();
        LinxBreakend breakend4 = LinxTestFactory.breakendBuilder().svId(2).build();
        LinxBreakend breakend5 = LinxTestFactory.breakendBuilder().svId(3).build();
