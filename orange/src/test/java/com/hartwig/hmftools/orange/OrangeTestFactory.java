...
public final class OrangeTestFactory {
    ...
    private static final String PURPLE_GENE_COPY_NUMBER_TSV = RUN_DIRECTORY + "/purple/sample.purple.cnv.gene.tsv";
    ...
    private static final String CUPPA_CONCLUSION_TXT = RUN_DIRECTORY + "/cuppa/sample.cuppa.conclusion.txt";
