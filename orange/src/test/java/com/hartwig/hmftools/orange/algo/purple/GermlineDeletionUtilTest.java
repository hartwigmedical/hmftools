...
public class GermlineDeletionUtilTest
{
    ...
    {
        GermlineDeletion deletion1 =
                GermlineDeletionTestFactory.create(TEST_GENE, true, GermlineStatus.HOM_DELETION, 0.2D, 100, 1000);
        GermlineDeletion deletion2 =
                GermlineDeletionTestFactory.create(TEST_GENE, true, GermlineStatus.HOM_DELETION, 0.1D, 100, 1000);
    ...
    {
        GermlineDeletion deletion1 =
                GermlineDeletionTestFactory.create(TEST_GENE, true, GermlineStatus.HOM_DELETION, -0.3D, 100, 1000);
        GermlineDeletion deletion2 =
                GermlineDeletionTestFactory.create(TEST_GENE, true, GermlineStatus.HOM_DELETION, 0.1D, 100, 1000);
    ...
    public void testDeletionCoversTranscriptDifficult()
    {
        ...
        GermlineDeletion deletion1 =
                GermlineDeletionTestFactory.create(TEST_GENE, true, GermlineStatus.HOM_DELETION, 0.1D, 100, 150);
        GermlineDeletion deletion2 =
                GermlineDeletionTestFactory.create(TEST_GENE, true, GermlineStatus.HET_DELETION, 1.2D, 200, 300);
        GermlineDeletion deletion3 =
                GermlineDeletionTestFactory.create(TEST_GENE, true, GermlineStatus.HOM_DELETION, 0.D, 275, 325);
        GermlineDeletion deletion4 =
                GermlineDeletionTestFactory.create(TEST_GENE, true, GermlineStatus.HOM_DELETION, 0.D, 302, 700);
        GermlineDeletion deletion5 =
                GermlineDeletionTestFactory.create(TEST_GENE, true, GermlineStatus.HET_DELETION, 3.1D, 701, 1000);
    ...
    public void testFindCopyNumberForGene()
    {
        ...
        List<GeneCopyNumber> geneCopyNumbers = Lists.newArrayList(
                otherGeneCopyNumber1,
                geneCopyNumberToFind,
                otherGeneCopyNumber2
        );
