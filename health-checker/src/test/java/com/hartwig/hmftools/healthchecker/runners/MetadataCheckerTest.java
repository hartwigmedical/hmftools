...
public class MetadataCheckerTest {
    ...
    public void canReadCorrectMetaDataSomatic() throws IOException, HartwigException {
        final RunContext runContext = TestRunContextFactory.forSomaticTest(RUN_DIRECTORY_SOMATIC, REF_SAMPLE, TUMOR_SAMPLE);
    ...
    public void canReadCorrectMetaDataSingleSample() throws IOException, HartwigException {
        final RunContext runContext = TestRunContextFactory.forSingleSampleTest(RUN_DIRECTORY_SINGLE_SAMPLE, REF_SAMPLE);
