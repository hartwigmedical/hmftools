...
import static com.hartwig.hmftools.common.sv.SvVcfTags.SAGA_VARIANT_ID_DESC;
...
public class VcfWriter implements AutoCloseable
{
    ...
    private void writeHeader(final SAMSequenceDictionary sequenceDictionary)
    {
        ...
        metaData.add(new VCFInfoHeaderLine(SAGA_VARIANT_ID, 1, VCFHeaderLineType.String, SAGA_VARIANT_ID_DESC));
    ...
    public void addBreakend(final Breakend breakend)
    {
        ...
        if (sagaMatch != null)
        {
            builder.attribute(SAGA_VARIANT_ID, sagaMatch.variant().id());
        }
