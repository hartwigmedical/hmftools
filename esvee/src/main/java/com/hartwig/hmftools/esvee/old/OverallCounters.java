...
public class OverallCounters
{
    ...
    */
    ...
    public final com.hartwig.hmftools.esvee.assembly.old.PrimaryAssemblerCounters PrimaryAssemblerCounters = new PrimaryAssemblerCounters();
    public final com.hartwig.hmftools.esvee.assembly.old.AssemblyExtenderCounters AssemblyExtenderCounters = new AssemblyExtenderCounters();
