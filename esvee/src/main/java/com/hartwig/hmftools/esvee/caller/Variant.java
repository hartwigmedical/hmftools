...
import static com.hartwig.hmftools.common.sv.SvVcfTags.SAGA_VARIANT_ID;
...
public class Variant
{
    ...
    private final boolean mHasSagaMatch;
    ...
    public Variant(final StructuralVariant sv, final GenotypeIds genotypeIds)
    {
        ...
        mHasSagaMatch = hasSagaMatch(sv.startContext()) || hasSagaMatch(sv.endContext());
    }
    ...
    public boolean hasSagaMatch()
    {
        return mHasSagaMatch;
    }
    ...
    private static boolean hasSagaMatch(@Nullable final VariantContext context)
    {
        return context != null && context.hasAttribute(SAGA_VARIANT_ID);
    }
}
